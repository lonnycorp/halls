...
pub fn create_bind_group_layout(device: &wgpu::Device) -> wgpu::BindGroupLayout {
    return device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
        ...
        entries: &[
            ...
            TextureIndexStorageBuffer::bind_group_layout_entry(1),
            MaterialIndexStorageBuffer::bind_group_layout_entry(2),
        ],
    });
}
...
impl PipelineLevelBindGroupConfig {
    pub fn new(
        ...
        texture_index: &TextureIndexStorageBuffer,
        ...
        let bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                ...
                texture_index.bind_group_entry(1),
                material_index.bind_group_entry(2),
            ],
        });
